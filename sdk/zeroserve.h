...
/* Look up a key in the server-managed key-value map (populated from --kv-map-file).
 * The map is a flat JSON object with string keys and string values.
...
extern zs_s64 zs_kv_get(const char *key, zs_u64 key_len,
